...
import com.gcom.service.login.UsersVO;
     ...
     protected static Logger logger = Logger.getLogger("UserDetailsService");
       ...
       public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new UsersVO(users.getUsername(), users.getFirstname()+" "+users.getLastname(),users.getPassword(), enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, getGrantedAuthorities(users.getAuthoritieses()),users.getInfo(),users.getFirstname(),users.getLastname(),users.getInfo2());
         } catch (Exception e)
         {
