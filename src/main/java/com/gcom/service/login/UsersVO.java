...
public class UsersVO implements Serializable, UserDetails {
    ...
    public UsersVO(String username, String fullName, String password,
                   boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired,
                   boolean accountNonLocked, List<GrantedAuthority> list, String info,
                   String firstname, String lastname, String info2) {
        this.username = username;
